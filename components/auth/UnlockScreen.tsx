...
import { Fingerprint, KeyRound, RotateCcw, AlertCircle, Eye, EyeOff, Lock, ScanFace } from 'lucide-react';
...
export function UnlockScreen({ onUnlocked, onRecovery }: UnlockScreenProps) {
  ...
  const handlePrfUnlock = useCallback(async () => {
    ...
    try {
      ...
      setError(
        msg.includes('cancelled') || msg.includes('NotAllowed')
