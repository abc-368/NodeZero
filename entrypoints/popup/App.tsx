...
import { ArrowLeft, Shield, RefreshCw, Sun, Moon, Key, Upload, Download, ScanFace, KeyRound } from 'lucide-react';
...
function SettingsScreen({ onBack, onSync, onExportVault, onImport, onExport, syncing, syncStatus }: SettingsScreenProps) {
                      ...
                      if (mode === 'biometric' && vaultPrimaryType === 'pin') {
                        ...
                        try {
                          ...
                          if (msg.includes('cancelled') || msg.includes('NotAllowed')) {
                            // User cancelled Windows Hello — stay on passphrase
                          } else {
                            setUpgradeError('Biometric setup failed. Try again.');
